        ...
        <section>
          <div className="container mx-auto px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
            <div className="max-w-lg mx-auto text-center">
              <h2 className="text-4xl sm:text-5xl font-bold text-transparent bg-clip-text leading-12 bg-gradient-to-r from-black via-teal-700 to-black">
            ...
            <div className="mt-8 grid grid-cols-1 gap-8 sm:grid-cols-1 lg:grid-cols-2 md:grid-cols-1">
                ...
                <div key={index} className="p-8 rounded-xl shadow-xl hover:border-teal-900/30 hover:shadow-teal-900/80 transition duration-300 ease-in-out">
                  ...
                  <div className="flex justify-between">
                    ...
                    <a href={project.github} target="_blank" rel="noopener noreferrer">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="h-7 w-7 cursor-pointer text-black hover:text-teal-900/80 transition duration-300 ease-in-out">
                  ...
                  <p className="mt-4 text-sm text-gray-900">{project.description}</p>
                </div>
              ))}
            </div>
          </div>
